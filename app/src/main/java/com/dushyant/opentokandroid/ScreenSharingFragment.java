...
public class ScreenSharingFragment extends Fragment {
    ...
    public ScreenSharingCapturer1 getScreenCapturer() {
        return mScreenCapturer;
    }

    private ScreenSharingCapturer1 mScreenCapturer;
    ...
    private void setUpVirtualDisplay() {
        ...
        mScreenCapturer = new ScreenSharingCapturer1(getActivity(), mScreen, mImageReader);
