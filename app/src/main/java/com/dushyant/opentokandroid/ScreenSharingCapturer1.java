 ...
 */
public class ScreenSharingCapturer1 extends BaseVideoCapturer{
    private static final String LOG_TAG = ScreenSharingCapturer1.class.getSimpleName();
     ...
     */
    @TargetApi(Build.VERSION_CODES.KITKAT)
    public ScreenSharingCapturer1(Context context, View view, ImageReader imageReader) {
